...
def get_urls(search='flower', n=10, download=False):
    ...
    if download:
        dir = os.getcwd() + os.sep + 'images' + os.sep + search + os.sep  # save directory
...
if __name__ == '__main__':
    ...
    parser.add_argument('--search', type=str, default='flower', help='flickr search term')
